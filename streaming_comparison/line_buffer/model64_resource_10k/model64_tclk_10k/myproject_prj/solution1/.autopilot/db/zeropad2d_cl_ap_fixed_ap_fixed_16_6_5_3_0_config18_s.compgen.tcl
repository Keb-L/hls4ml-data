...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_0_V_V_TDATA { I 16 vector } data_0_V_V_TVALID { I 1 bit } data_0_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_1_V_V_TDATA { I 16 vector } data_1_V_V_TVALID { I 1 bit } data_1_V_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { data_2_V_V_TDATA { I 16 vector } data_2_V_V_TVALID { I 1 bit } data_2_V_V_TREADY { O 1 bit } } \
} "
} else {
